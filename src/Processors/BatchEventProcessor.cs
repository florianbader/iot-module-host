...
public class BatchEventProcessor : IDisposable
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BatchEventProcessor"/> class.
    /// </summary>
    ...
    public BatchEventProcessor(IModuleClient moduleClient, int capacity, TimeSpan timeout, ILogger logger)
    ...
    /// <param name="timeout">The timeout after which the throttled messages are sent at the latest.</param>
    /// <param name="logger">The logger.</param>
    public BatchEventProcessor(IModuleClient moduleClient, int capacity, int maxMessageSize, TimeSpan timeout, ILogger logger)
        : this(moduleClient, capacity, maxMessageSize, timeout, new SystemTime(), logger)
    {
    }

    internal BatchEventProcessor(IModuleClient moduleClient, int capacity, int maxMessageSize, TimeSpan timeout, ISystemTime systemTime, ILogger logger)
    {
